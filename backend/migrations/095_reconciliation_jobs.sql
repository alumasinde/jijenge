...
INSERT INTO reconciliation_job_statuses (code,name) VALUES
('RUNNING','Running'),
('COMPLETED','Completed'),
('FAILED','Failed');
...
CREATE TABLE reconciliation_jobs (
    ...
    KEY idx_reconciliation_jobs_provider_status (
        provider_code,status_id,created_at
    ),
    CONSTRAINT fk_reconciliation_jobs_status
        FOREIGN KEY (status_id) REFERENCES reconciliation_job_statuses(id)
