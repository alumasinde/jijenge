...
from app.Modules.Execution.routes import router as job_execution_router
...
from app.Modules.Financials.execution_routes import router as financial_execution_router
...
from app.Modules.JobLifecycle.routes import router as job_lifecycle_router
...
for module_router in (
    ...
    reviews_router, verification_router, trust_router, job_execution_router, job_lifecycle_router,
    commission_router, job_payment_router, settlement_router, financial_execution_router,
